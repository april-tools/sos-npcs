...
parser.add_argument(
    "tboard_path", type=str, help="The Tensorboard runs path"
)
parser.add_argument(
...
if __name__ == '__main__':
    ...
    rel_num_sum_parameters = (np.max(num_sum_parameters) - np.min(num_sum_parameters)) / np.min(num_sum_parameters)
