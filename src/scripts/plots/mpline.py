...
parser.add_argument(
    "tboard_path", default="tboard-runs", type=str, help="The Tensorboard runs path"
)
parser.add_argument("--metric", default="avg_ll", help="The metric to plot")
parser.add_argument(
    "--datasets", type=str, default="power;gas;hepmass;miniboone", help="Dataset names"
)
        ...
        for j, dataset in enumerate(datasets):
            ...
            for k, (model, alias) in enumerate(zip(models, exp_aliases)):
                ...
                hparams_dicts = [
                    ...
                    for values in itertools.product(*hparams.values())
                ]
            ...
            ax[i, j].grid(linestyle="--", alpha=0.3, linewidth=0.5)
