...
parser.add_argument(
    "--embedding-double-clamp",
    default=False,
    action="store_true",
    help="Clamp parameters of Embedding layers in SOS PCs to be away from 0 by a tiny value. This might be required for better numerical stability",
)
parser.add_argument(
    "--reduce-lr-plateau",
    action="store_true",
